...
> **Question 10**: Start the monitoring period the end of last year. Is the current year an abnormal year? Illustrate this with your own time series from a flux tower of your own choice.
...
Especially, if you want to learn how to apply BFAST on Landsat data go the [tutorial on BFASTspatial](http://www.loicdutrieux.net/bfastSpatial/). Now, try to reproduce the results shown in this tutorial and visualise the change with a magnitude smaller than -0.1 in a map for the study area (i.e. tura brick). *Tip*: Reduce the size of the Tura brick, the make sure the processing on the Tura brick takes up too much time (use the `crop` function).
