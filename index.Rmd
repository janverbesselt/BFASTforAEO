...
pkgTest <- function(x)
{
  if (x %in% rownames(installed.packages()) == FALSE) {
    if (x == "bfastSpatial") devtools::install_github("loicdtx/bfastSpatial") else
        install.packages(x, dependencies= TRUE)
  }
  library(x, character.only = TRUE)
}
neededPackages <- c("strucchange","zoo", "bfast", "raster", "leaflet", "MODISTools", "devtools", "bfastSpatial")
