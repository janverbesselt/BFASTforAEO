...
```{block, type="alert alert-success"}
> **Question 7**:  Now try to detect a change in 2019 for the Victoria Zigzag Creek site in Australia, available via the [https://modis.ornl.gov/sites/](https://modis.ornl.gov/sites/) website.
For your answer, (a) check what BFAST Monitor parameters are most appropriate for the pixel 1077 of the site,
(b) what is the landcover type of this pixel,
