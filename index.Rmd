...
```{block, type="alert alert-success"}
> **Question 3**:  What happens if you use a different *formula* in `bfastmonitor? For example, `response ∼ trend`. Explain what happens and also in which sense in 2018 an abnormal year? 
```
