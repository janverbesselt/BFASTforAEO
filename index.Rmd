...
neededPackages <- c("strucchange","zoo", "bfast", "raster", "leaflet")
for (package in neededPackages){pkgTest(package)}
```

Installing the latest MODISTools package:
```{r, echo=TRUE, message=FALSE, eval=TRUE}
# with the below code we install the latest version of MODISTools package
# via https://github.com/khufkens/MODISTools
if(!require(devtools)){install.package("devtools")}
devtools::install_github("khufkens/MODISTools")
library("MODISTools")
```

Loading an extra function to create time series 
