...
In this exercise we will automatically download MODIS data for specific locations around the world. 
First, MODIS satellite data is describd. Second, the use of R is introduced. Finally, the exercise in R is explained, step by step. 

# MODIS satellite data

The MODIS satellite data that we will download for this time series analysis exercise is available from [the following site](http://daac.ornl.gov/cgi-bin/MODIS/GR_col5_1/mod_viz.html). MODIS data is made available for speficic locations. 
...
[MODIS Landsubset website](http://daac.ornl.gov/cgi-bin/MODIS/GR_col5_1/mod_viz.html) and can be loaded in R via the R script below. 
