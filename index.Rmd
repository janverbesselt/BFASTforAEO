...
> **Question 1**: What is the key land cover type in the center of the site? (see additional information on the bottom of the [MODIS13Q1 page](https://modis.ornl.gov/cgi-bin/sites/site/?id=nl_gelderland_loobos&product=MOD13Q1))
```
...
#     r <- do.call(raster::stack, lapply(dates, function(date) {
...
```{block, type="alert alert-success"}
> **Question 4**:  Now try to detect a change in 2018 for another site in the world available via the [https://modis.ornl.gov/sites/](https://modis.ornl.gov/sites/) website. In your answer, mention (1) site, (2) bfastmonitor settings, (3) landcover type of that pixel and the pixel number (4) add the plot of the time series together with explanation of the difference in seasonality and detected change between the loobos site and your choosen site.
```
